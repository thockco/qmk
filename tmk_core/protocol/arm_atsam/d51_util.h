...
#define DBG_LED_TGL PORT->Group[DEBUG_LED_PORT].OUTTGL.reg = (1 << DEBUG_LED_PIN)
#else
#define DBG_LED_ENA
#define DBG_LED_DIS
#define DBG_LED_ON
...
enum debug_code_list {
    ...
    DC_CLK_ENABLE_TIMEBASE_TC2_BEGIN,
    DC_CLK_ENABLE_TIMEBASE_TC2_SYNC_DISABLE,
    DC_CLK_ENABLE_TIMEBASE_TC2_SYNC_SWRST_1,
    DC_CLK_ENABLE_TIMEBASE_TC2_SYNC_SWRST_2,
    DC_CLK_ENABLE_TIMEBASE_TC2_SYNC_CLTRB,
    DC_CLK_ENABLE_TIMEBASE_TC2_SYNC_CC0,
    DC_CLK_ENABLE_TIMEBASE_TC2_COMPLETE,
